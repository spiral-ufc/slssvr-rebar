...
% Rebar dataset | SLSSVR Model (kmeans)
...
for step_output = 1:4
    ...
    for step_random_seed = 1:100
        ...
        for step_number_of_clusters = 1:number_of_clusters
            ...
            [~, centroids] = kmeans([dataset.input_train_norm;dataset.output_train_norm]', 1040 - (step_number_of_clusters) * 10,'Distance','sqeuclidean');
        ...
        save(sprintf('results/kmeanslssvr_r_squared_%d.dat',step_output),'r_squared','-ascii')
    end
end
